...
function process(isGMT){
    ...
    var result = "<table class='mainTable' cellpadding='0' cellspacing='0'><tr>";
    result = result + "<td><div class='taskColumn assignToColumn'></div></td>"
    
    for (var colIndex = 1; colIndex < cols.length; colIndex++){
        result = result + "<td><div class='taskColumn' style='width:" + colWidth + "px'>" +  cols[colIndex].text + "<br>" + cols[colIndex].date + "</div></td>"
    }
    result = result + "</tr>"
